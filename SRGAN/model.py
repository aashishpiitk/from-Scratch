...
class GeneratorResNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, n_residual_blocks=16, SR_factor=2):
        super(GeneratorResNet, self).__init__()
        self.SR_factor = int(math.log(SR_factor,2))
        ...
        upsampling = []
        for out_features in range(self.SR_factor):
            upsampling += [
...
class Discriminator(nn.Module):
    def __init__(self, input_shape, SR_factor=2, debug=False):
